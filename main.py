...
def predict(text):
    ...
    #Melakukan prediksi dari teks masukan
...
def get_explanation(types):
    # Mendapatkan penjelasan singkat mengenai label MBTI Final
    if types == "INFP":
    ...
    if select_pages == "MBTI Predictor":
        ...
        if st.button("Predict"):
            ...
            if text != "":
                ...
                # Kondisi apabila tombol prediksi ditekan namun text box masih kosong
